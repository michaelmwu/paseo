...
| [docs/agent-context-attachments.md](docs/agent-context-attachments.md) | Agent context attachments — reference data flow, source eligibility, privacy limits, and compatibility                         |
