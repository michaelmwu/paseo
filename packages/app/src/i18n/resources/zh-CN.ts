...
export const zhCN: TranslationResources = {
  ...
  workspace: {
    ...
    launches: {
      ...
      accessibility: {
        ...
        stopLaunch: "停止 {{launchName}}",
        viewTerminal: "查看 {{launchName}} 的终端",
  ...
  providerUsage: {
    ...
    empty: "暂无用量数据",
    errorTitle: "无法加载用量",
    hostUnavailable: "连接到此主机以查看提供商用量",
    ...
    timing: {
      resettingNow: "正在重置",
      resetsIn: "将在 {{duration}}后重置",
      runsOutNow: "即将用尽",
      runsOutIn: "将在 {{duration}}后用尽",
      justNow: "刚刚",
      daysAgo: "{{value}}天前",
      hoursAgo: "{{value}}小时前",
      minutesAgo: "{{value}}分钟前",
      updated: "更新于 {{relativeTime}}",
    },
  },
  settings: {
    title: "设置",
    ...
    project: {
      ...
      launches: {
        title: "启动配置",
        info: "可从此项目的任何工作区启动的开发配置",
        empty: "还没有启动配置。",
        untitled: "未命名启动配置",
        menuAccessibility: "打开启动配置菜单",
        removeTitle: "移除启动配置？",
        removeMessage: "移除 {{name}}？",
        removeFallbackName: "此启动配置",
        name: "名称",
        command: "命令",
        ...
        newLaunch: "新建启动配置",
        editLaunch: "编辑 {{name}}",
        commandHint: "Paseo 会使用工作区端口块和 Compose 项目名称作为环境变量运行此命令。",
        actions: { add: "添加启动配置", edit: "编辑", remove: "移除" },
      },
      metadata: {
        title: "元数据生成",
