...
export const ptBR: TranslationResources = {
  ...
  addTranscripts: {
    ...
    groups: {
      ...
      externalSessions: "Sessões externas",
    },
    status: {
      ...
      noTranscripts: "Não há transcrições disponíveis",
      ...
      providerSessionUnavailable: "Esta sessão do provedor não pode ser copiada como transcrição",
      transcriptOnlyDisclosure:
        "Somente transcrição: arquivos, branches, alterações não confirmadas, ferramentas, configurações e a sessão nativa permanecem no espaço de trabalho de origem.",
