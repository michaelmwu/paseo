...
export const ko: TranslationResources = {
  ...
  providerUsage: {
    ...
    hostUnavailable: "이 호스트에 연결하여 제공업체 사용량을 확인하세요",
    hostUpgradeRequired: "호스트를 업데이트하여 제공업체 사용량을 확인하세요",
    ...
    timing: {
      ...
      runsOutNow: "지금 한도에 도달",
      runsOutIn: "{{duration}} 후 한도에 도달",
      justNow: "방금",
      daysAgo: "{{value}}일 전",
      hoursAgo: "{{value}}시간 전",
      minutesAgo: "{{value}}분 전",
      updated: "{{relativeTime}}에 업데이트됨",
    },
  },
  settings: {
    title: "설정",
