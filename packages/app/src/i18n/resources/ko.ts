...
export const ko: TranslationResources = {
  ...
  providerUsage: {
    ...
    loading: "사용량 불러오는 중...",
    empty: "사용량 데이터 없음",
    errorTitle: "사용량을 불러올 수 없습니다",
    hostUnavailable: "프로바이더 사용량을 보려면 이 호스트에 연결하세요",
    hostUpgradeRequired: "프로바이더 사용량을 보려면 호스트를 업데이트하세요",
    clientUnavailable: "호스트 연결이 준비되지 않았습니다",
    retry: "다시 시도",
    tooltipLoading: "요금제 사용량 불러오는 중...",
    status: { error: "오류", unavailable: "사용할 수 없음" },
    values: { used: "{{percentage}} 사용됨", remaining: "{{amount}} 남음" },
    duration: { days: "{{value}}일", hours: "{{value}}시간", minutes: "{{value}}분" },
    timing: {
      resettingNow: "지금 재설정 중",
      resetsIn: "{{duration}} 후 재설정",
      runsOutNow: "지금 소진됨",
      runsOutIn: "{{duration}} 후 소진",
      justNow: "방금 전",
      daysAgo: "{{value}}일 전",
      hoursAgo: "{{value}}시간 전",
      minutesAgo: "{{value}}분 전",
      updated: "{{relativeTime}} 업데이트됨",
    },
  },
  settings: {
    title: "설정",
