...
export const ar: TranslationResources = {
  ...
  addTranscripts: {
    ...
    status: {
      ...
      providerSessionUnavailable: "لا يمكن نسخ جلسة الموفر هذه كنص محادثة",
      transcriptOnlyDisclosure:
        "النص فقط: تبقى الملفات والفروع والتغييرات غير الملتزم بها والأدوات والإعدادات والجلسة الأصلية في مساحة العمل المصدر.",
