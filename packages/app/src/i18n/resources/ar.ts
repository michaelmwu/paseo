...
export const ar: TranslationResources = {
  localFiles: {
    updateHost: "حدّث هذا المضيف لاستيراد الملفات المحلية.",
    missingTitle: "ملفات محلية مفقودة",
    missingConfirm:
      "الملفات {{files}} غير موجودة في {{root}}. هل تريد المتابعة بدونها؟ ألغِ العملية لاستيرادها أولاً.",
    continueWithout: "المتابعة بدون ملفات",
    unavailableForWorktree: "تحقق من هذه الملفات المحلية قبل إنشاء worktree: {{files}}",

    title: "الملفات المحلية",
    info: "استورد ملفات البيئة والإعدادات التي يتجاهلها Git إلى هذا المضيف. يمكن لوكلائه وبرامجه النصية قراءتها.",
    import: "استيراد ملفات…",
    importTo: "استيراد إلى {{host}}",
    thisDevice: "هذا الجهاز",
    fromDevice: "من هذا الجهاز…",
    fromHost: "من مضيف آخر…",
    source: "المصدر: {{source}}",
    sourcePath: "ملف مصدر آخر (مسار نسبي للمشروع)",
    inspect: "فحص",
    refresh: "تحديث",
    total: "المحدد: {{count}} · {{size}}",
    include: "تضمين في أشجار العمل المستقبلية",
    configPreview:
      "إضافة هذه المسارات إلى paseo.json. ينشئ هذا تغيير إعدادات غير مُثبّت؛ تبقى ملفات أشجار العمل الحالية كما هي.",
    complete: "تم استيراد الملفات. لم تُحدّث أشجار العمل الحالية.",
    limits: "ملفات منفردة فقط. الحد الأقصى 10 MiB للملف و25 MiB للاستيراد و100 ملف. التحديثات يدوية.",
    existing: "موجود بالفعل · حدد للاستبدال",
    replace: "استبدال {{path}}",
    status: {
      ready: "موجود",
      missing: "مفقود",
      not_ignored: "يجب أن يتجاهله Git",
      unsupported: "ملف أو مسار غير مدعوم",
      too_large: "كبير جدًا",
      unavailable: "غير متاح",
      imported: "تم الاستيراد",
    },
    errors: {
      load_failed: "تعذر فحص الملفات. تحقق من اتصال المضيف وحاول مجددًا.",
      selection_invalid: "اختر 100 ملف كحد أقصى بأسماء مختلفة.",
      no_source_files: "لم تُعثر على ملفات مؤهلة. أدخل مسار ملف يتجاهله Git لفحصه.",
      changed: "تغير الملف منذ المعاينة. اختر المصدر مجددًا لمراجعة النسخة الحالية.",
      import_failed: "فشل الاستيراد. تحقق من الاتصال وحاول مجددًا.",
      partial_failure: "فشلت بعض الملفات. أعد محاولة العناصر المحددة أو اختر المصدر مجددًا.",
      secure_connection_required:
        "استخدم اتصال ترحيل أو TLS أو اتصالًا محليًا/SSH لنقل الملفات الحساسة.",
      config_failed:
        "تم استيراد الملفات لكن لم يُحفظ التضمين. حدّث لمراجعة الإعدادات ثم احفظ التضمين دون إعادة نقل الملفات.",
    },
  },
  ...
  workspace: {
    ...
    launches: {
      ...
      accessibility: {
        ...
        stopLaunch: "إيقاف {{launchName}}",
        viewTerminal: "عرض محطة {{launchName}}",
  ...
  agentContext: {
    title: "إرفاق وكلاء",
    subtitle: "امنح هذا الوكيل سياقًا من وكيل آخر على هذا المضيف.",
    ...
    sameHostNote: "يُلتقط سياق الوكيل عند إرسال الطلب.",
  },
  loadOlderHistory: {
  ...
  providerUsage: {
    ...
    errorTitle: "تعذّر تحميل بيانات الاستخدام",
    hostUnavailable: "اتصل بهذا المضيف لعرض استخدام المزوّد",
    hostUpgradeRequired: "حدّث المضيف لعرض استخدام المزوّد",
  ...
  settings: {
    ...
    project: {
      ...
      launches: {
        title: "عمليات التشغيل",
        info: "تكوينات التطوير التي يمكنك تشغيلها من أي مساحة عمل في هذا المشروع",
        empty: "لا توجد عمليات تشغيل بعد.",
        untitled: "تشغيل بلا عنوان",
        menuAccessibility: "فتح قائمة التشغيل",
        removeTitle: "إزالة التشغيل؟",
        removeMessage: "إزالة {{name}}؟",
        removeFallbackName: "هذا التشغيل",
        name: "الاسم",
        command: "الأمر",
        ...
        commandHint: "يشغّل Paseo هذا الأمر مع كتلة منافذ مساحة العمل واسم مشروع Compose في البيئة.",
        actions: { add: "إضافة تشغيل", edit: "تعديل", remove: "إزالة" },
      },
      metadata: {
