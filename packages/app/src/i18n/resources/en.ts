export const en = {
  ...
  addTranscripts: {
    ...
    status: {
      ...
      providerSessionUnavailable: "This provider session can't be copied as a transcript",
      transcriptOnlyDisclosure:
        "Transcript only: files, branches, uncommitted changes, tools, settings, and the native session stay in the source workspace.",
