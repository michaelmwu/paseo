...
export const es: TranslationResources = {
  ...
  addTranscripts: {
    ...
    status: {
      ...
      providerSessionUnavailable: "Esta sesión del proveedor no se puede copiar como transcripción",
      transcriptOnlyDisclosure:
        "Solo transcripción: los archivos, las ramas, los cambios sin confirmar, las herramientas, la configuración y la sesión nativa permanecen en el espacio de trabajo de origen.",
