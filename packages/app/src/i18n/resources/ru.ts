...
export const ru: TranslationResources = {
  ...
  addTranscripts: {
    ...
    groups: {
      ...
      externalSessions: "Внешние сеансы",
    },
    status: {
      ...
      noTranscripts: "Нет доступных расшифровок",
      ...
      providerSessionUnavailable: "Этот сеанс поставщика нельзя скопировать как расшифровку",
      transcriptOnlyDisclosure:
        "Только расшифровка: файлы, ветки, незакоммиченные изменения, инструменты, настройки и нативный сеанс остаются в исходном рабочем пространстве.",
