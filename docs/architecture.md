...
- Agent context attachments are source-daemon-curated references. Cross-host sends prefer destination-bound encrypted capsules and require confirmation before a readable compatibility relay; see [agent-context-attachments.md](agent-context-attachments.md) for the privacy, retention, and compatibility contract.
