...
- Agent context attachments are daemon-resolved, same-host references rather than client-carried transcripts; see [agent-context-attachments.md](agent-context-attachments.md) for the privacy, retention, and compatibility contract.
